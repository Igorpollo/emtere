...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { fim: @evento.fim, inicio: @evento.inicio, nome: @evento.nome, texto: @evento.texto } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { fim: @evento.fim, inicio: @evento.inicio, nome: @evento.nome, texto: @evento.texto } }
