...
class ArtigosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artigo" do
    assert_difference('Artigo.count') do
      post artigos_url, params: { artigo: { texto: @artigo.texto, titulo: @artigo.titulo, user_id: @artigo.user_id } }
    end
  ...
  test "should update artigo" do
    patch artigo_url(@artigo), params: { artigo: { texto: @artigo.texto, titulo: @artigo.titulo, user_id: @artigo.user_id } }
